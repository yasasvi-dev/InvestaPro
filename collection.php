        ...
        <div class="d-flex flex-column justify-content-center align-items-center">
          ...
          <div class="d-flex" data-aos="fade-up" data-aos-delay="200">
            <center>
              <div class="p-5">
                <div class="col-lg-10">
                <form action="savecollection.php" id="collectionform" method="post" class="php-email-form" style="background-color: lightblue;" data-aos="fade-up" data-aos-delay="400">
                    <?php
                    ...
                    <div class="row gy-4 col-lg-6">
                        ...
                        <input type="text" name="account_type" id="account_type" class="form-control w-100" value="Collection" disabled required="">
